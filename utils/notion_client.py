...
class NotionStoryManager:
    ...
    def __init__(self, database_id: Optional[str] = None):
        ...
        if not self.database_id:
            raise ValueError("NOTION_DATABASE_ID environment variable or parameter is required")
            ...
            properties = {
                "Title": {
                    "title": [
                        {
                            "text": {
                                "content": story_data.get("prompt", "Untitled Story")[:100]
                            }
                        }
                    ]
                },
                        ...
                        "rich_text": [
                            {
                                "type": "text",
                                "text": {
                                    "content": self._truncate_text(story_data.get("ideas", ""))
                                }
                            }
                        ]
                    }
                        ...
                        "rich_text": [
                            {
                                "type": "text",
                                "text": {
                                    "content": self._truncate_text(story_data.get("story", ""))
                                }
                            }
                        ]
                    }
    ...
    def update_story_page(self, page_id: str, story_data: Dict[str, Any]) -> Dict[str, Any]:
        """
